-- Corrige a ambiguidade entre o parâmetro de saída "id" e as colunas das tabelas.
-- Idempotente e seguro para ambientes em que a função anterior já foi aplicada.
